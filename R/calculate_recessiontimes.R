...
extract_recessiontimes_allstations<-function(fraction=0.995, stations_periods_file="../Data/Flooddata/Table_stations_periods.csv",dailydata="../Data/Dailydata",
  ...
  write.table(myre,file=outfile,row.names=FALSE)
  return(myrec)
}
